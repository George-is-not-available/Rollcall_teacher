...
import imageUrl from '../public/AD.png';
import imgepay from '../public/payment.png';
    ...
    return (
        <div>
            ...
            {showPayPrompt && (
                <div style={{
                    ...
                    <div style={{ textAlign: "center" }}>
                        <button onClick={() => setShowPayPrompt(false)}>关闭</button>
                    </div>
                </div>
            )}
            ...
            <Button onClick={() => {
                ...
                <IconEdit />{changePointsButton ? '确认分数' : '修改分数'}
            </Button>
